...
public class UsuarioDAO implements DAO<Usuario, Integer> {
	...
	public List<Usuario> getUsuariosTuristas(){
		return usuarios.stream().filter(usu -> usu.isTurista() == true).collect(Collectors.toList());
	}
	
	public List<Usuario> getUsuariosNaoTuristas(){
		return usuarios.stream().filter(usu -> usu.isTurista() == false).collect(Collectors.toList());
	}
